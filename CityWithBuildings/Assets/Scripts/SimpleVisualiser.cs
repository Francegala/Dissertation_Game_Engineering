...
public class SimpleVisualiser : MonoBehaviour
{
    ...
    //list of all game objects to delete every time we create new
    private List<GameObject> objectsCreated = new List<GameObject>();

    //place prefab where agent has visited
    public GameObject prefab;
    // line renderer class from unity to render line to visualise path using lines
...
//map the sequence tp concrete commands to the agent
    ...
    private void VisualiseSequence(string sequence)
    {
        ...
        // when drawing road set temp to current position then calculate end posiiton and draw line from temp to next position that will be current
